...
function CourseFree() {
  ...
  useEffect(() => {
    const action = getAllCoursesAction(page, { ...search, cost: "0" });
    dispatch(action);
    moment.locale("vi");
  }, [page, search]);
  ...
  return (
    <>
      ...
      <div className="page-content bg-white">
        ...
        >
          <PageTitle motherName="Trang chủ" activeName="Khóa học miễn phí" />
        </div>
                      ...
                      <div className="post-bx">
                        <div className="d-flex m-b30">
                          <div className="job-post-info">
                            ...
                            <ul>
                              <li>
                                <i className="fa fa-map-marker"></i> Hoàn Kiếm,
                                Hà Nội
                              </li>
                              <li>
                              ...
                              <li>
                                <i className="fa fa-clock-o"></i> Từ 11 tháng
                                trước
                              </li>
                            </ul>
                          </div>
                        ...
                        <div className="d-flex">
                          <div className="job-time mr-auto"></div>
